...
<img src="./images/ncsa-mosaic-1.0.jpg" width="600">
...
<img src="./images/netscape2-first-release-javascript.png" width="600">"
...
<img src="./images/animation-using-javascript.png" width="600">   
...
3. Setelah kedua berkas dibuat, buka *web browser* favorit kalian.
   ...
   kosong   
   <img src="./images/web-browser-open-hello-world-html.png" width="600">
...
4. Selanjutnya, tekan tombol `F12` untuk masuk ke jendela *Developer Tools*
   ...
   <img src="./images/hello-world-output.png" width="600">
...
5. Kita dapat mengubah-ubah isi dari `hello.js`, lalu kita perlu
   ...
   *web browser* sudah memuat suatu program untuk menerjemahkan kode
   ...
   <img src="./images/three-windows-to-edit-refresh-update.png" width="600">
...
1. Pertama-tama, unduh berkas *installer* di tautan berikut: 
   ...
   <img src="./images/download-vscode-installer.png" width="600">
...
3. Jika telah selesai dilakukan instalasi, maka akan muncul tampilan jendela
   *Welcome page*
   <img src="./images/welcome-page-vscode.png" width="600">   
...
JavaScript   
<img src="./images/nodejs-and-vscode.png" width="800">
...
<img src="./images/markdown-example.png" width="800">
...
1. Write your summary or findings after reading this chapter.
