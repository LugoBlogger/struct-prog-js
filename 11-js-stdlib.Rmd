...
In this chapter, we are going to discuss some standard libraries or sometimes 
they are called as *functions* and *class* which are available by default
...
1. Pilih dan telusuri satu [Web APIs](https://developer.mozilla.org/en-US/docs/Web/API) 
...
2. Berikut ini diberikan data *last access* LMS ITK untuk mahasiswa
